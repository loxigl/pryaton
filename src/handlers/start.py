...
async def start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if db_user:
        ...
        welcome_text = (
            ...
            f"🏠 Добро пожаловать в главное меню бота PRYTON.\n"
    ...
    welcome_text = (
        ...
        f"🎮 Добро пожаловать в бота проекта <b>PRYTON</b>.\n\n"
...
async def process_rules_confirmation(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    success_text = (
        ...
        f"✅ Вы успешно зарегистрировались в системе PRYTON.\n\n"
        f"🎮 Теперь вы можете:\n"
