...
class SettingsService:
    ...
    def _get_or_create_default_rules() -> None:
        ...
        if db.query(GameRule).filter(GameRule.is_active == True).count() == 0:
            default_rules = """
🎮 <b>Правила игры PRYTON</b>

<b>Описание игры:</b>
PRYTON - это игра в прятки на автомобилях, где один или несколько игроков (водители) прячутся в выбранном районе, а остальные участники (искатели) пытаются их найти.
